    ...
    <div className='favourite'>
      ...
      <div className="w-[100%] flex">
        ...
        <h3 className='text-[1.5rem] mb-[5px] leading-[1.2rem] font-[600]'>Danh mục cho thuê</h3>
            <ul>
              <li className='flex text-center '  > <FaChevronRight className='mt-[4px]' /> Cho thuê Homestays độc lập</li>
              <li className='flex text-center '  > <FaChevronRight className='mt-[4px]' /> Cho thuê Homestay nhóm</li>
              <li className='flex text-center '  > <FaChevronRight className='mt-[4px]' /> Cho thuê Homestay nghỉ dưỡng</li>
            </ul>
        </div>
      </div>
