      ...
      <div className="w-[100%] flex">
        ...
        <div className=" bg-white w-[100%] h-[200px]  border-[1px] p-[10px] mb-[10px]">
          <h3 className='text-[1.5rem] mb-[5px] leading-[1.2rem] font-[600]'>Danh mục cho thuê</h3>
            <ul>
              <li className='flex text-center text-[1.1rem] font-[500] py-[5px] hover:text-red-500'  > 
        ...
        <div className=" bg-white w-[100%] h-[200px] ">
          ...
          <li className='flex text-[1.1rem] font-[500] p-[5px] hover:text-red-500'  > 
              <FaChevronRight className='mt-[6px]' /> 
              Quy trình đăng ký tạm trú cho người thuê phòng trọ mới nhất
          </li>
          <li className='flex text-[1rem] font-[500] p-[5px] hover:text-red-500'  > 
              <FaChevronRight className='mt-[6px]' /> 
