...
const PersonalPage = ({children}) => {
    ...
    const { username,phone ,id , money} = useSelector((state:any) => state.auth)
    useEffect(() => {
  ...
  return (
    <div className="">
        <div className="flex fixed w-[100vw] h-[100vh] overflow-y-auto">
            <div className="w-[20%]  bg-gray-100">
                <Link to={`/`}>
                    <div className="bg-[#055699] h-[40px] p-[5px] flex justify-center items-center" >
                ...
                <div className="w-[100%] min-h-[100%] p-[10px] overflow-y-auto">
                    ...
                    <p>Tài khoản chính : <span className='font-[600]'>{money} VND</span></p>
                    <div className="flex">
