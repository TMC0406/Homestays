            ...
            <div className="w-[20%] h-[97vh] bg-gray-100">
                <div className="bg-[#055699] h-[40px]" >
                    ...
                    <div className="w-[100%] min-h-[100%] p-[10px] overflow-y-auto">
                        ...
                        <div className="">
                            <ul>
                            <Link to="/pesonal/ManagePostings">
                            ...
                            <Link to="/pesonal/DepositHistory">
                            ...
                            <Link to="/pesonal/PaymentHistory">
                            ...
                            <Link to="/pesonal/ServicePriceList">
