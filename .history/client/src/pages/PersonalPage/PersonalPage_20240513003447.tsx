            ...
            <div className="w-[20%] min-h-[100vh] bg-gray-100">
                <div className="bg-[#055699] h-[40px]" >
                    ...
                    <div className="w-[100%] min-h-[100%] p-[10px]">
                        ...
                        <div className="flex">
                            <button className=' px-[10px] py-[5px] m-[5px] bg-yellow-700 text-white font-[700]'>Nạp tiền </button>
                            <button className=' px-[10px] py-[5px] m-[5px] bg-red-700 text-white font-[700]'>Đăng tin </button>
                        </div>
                    </div>               
                </div> 
            </div>
