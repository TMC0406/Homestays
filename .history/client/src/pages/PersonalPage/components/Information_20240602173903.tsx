      ...
      <form className="p-[30px] w-[70%]">
        <table className='w-[70%] m-[auto] border-spacing-3'>
          <tr>
            ...
            <td>
              <input type="text" value={id} className='border-[2px] min-w-[100%]' id='id' />
            </td>
          </tr>
          <tr>
            <td><label className='font-[500] text-[1.2rem]' htmlFor="phone">Số điện thoại</label></td>
            <td>
              <input type="text" value={phone} className='border-[2px] min-w-[100%]' id='phone' />
          ...
          <tr>
            ...
            <td>
              <input type="text" value={username} className='border-[2px] min-w-[100%]' id='username' />
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              <img className='w-[100px] h-[100px] shadow-[1px_1px_1px_1px_#a7acaf] rounded-[10rem]' src={avatar} alt="avatar" />
