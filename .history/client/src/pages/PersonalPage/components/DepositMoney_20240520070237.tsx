    ...
    <div className=" h-[100vh] ">
      ...
      <div className="w-[100%] h-[90vh] overflow-auto flex pb-[1000px]">
        ...
        <div className="w-[20%] min-h-[100%] border-[1px]">
            ...
            <button className="w-[100%] h-[30px] m-[5px] bg-[gray]">Lịch sử nạp tiền</button> <br />
            <button className="w-[100%] h-[30px] m-[5px] bg-[gray]">Lịch sử thanh toán</button> <br />
            <button className="w-[100%] h-[30px] m-[5px] bg-[gray]">Bảng giá dịch vụ</button>
        </div>
      </div>
