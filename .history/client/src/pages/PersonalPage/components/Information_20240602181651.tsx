      ...
      <form className="p-[30px] w-[70%]">
        <table className='w-[70%] m-[auto] border-spacing-3'>
          ...
          <tr>
            ...
            <td>
                   <InputForm
                      ...
                      setValue={setPayload}
                      keyPayload={'phone'}
                      type='phone' invalidFields={undefined} setInvalidFields={undefined}
                      />
          ...
          <tr>
            ...
            <td>
              <input placeholder='nhập mật số điện thoại' type="text" className=' p-[5px]  border-[2px] min-w-[100%]' id='zalo' />
            </td>
          </tr>
          <tr>
            ...
            <td>
              <input placeholder='nhập mật khẩu mới' type="text" className='p-[5px] border-[2px] min-w-[100%]' id='password' />
            </td>
          </tr>
          <tr>
