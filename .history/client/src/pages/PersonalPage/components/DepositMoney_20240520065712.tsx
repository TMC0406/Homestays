  ...
  return (
    <div className=" h-[100vh] ">
      ...
      <div className="w-[100%] h-[90vh] overflow-auto flex pb-[1000px]">
        ...
        <div className="w-[20%] min-h-[100%] border-[black] border-[1px]">
            <div className="w-[95%] h-[200px]  border-[1px] m-[5px]"></div>
            <button className="">Lịch sử nạp tiền</button>
            <button className="">Lịch sử thanh toán</button>
            <button className="">Bảng giá dịch vụ</button>
        </div>
      </div>
