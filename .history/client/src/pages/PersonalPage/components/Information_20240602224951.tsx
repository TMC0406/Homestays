      ...
      <form className="p-[30px] w-[70%]">
        <table className='w-[70%] m-[auto] border-spacing-3'>
          ...
          <tr>
            ...
            <td>
              <img className='w-[100px] h-[100px] shadow-[1px_1px_1px_1px_#a7acaf]  m-[10px]'
              ...
              onChange={
                (e) => {
                  ...
                  if (file) {
                    ...
                    reader.onload = () => {
                      setPayload((pre)=> ({...pre, avatar : reader.result}) )
                    };
...
{/* (e)=> setPayload((pre)=> ({...pre, avatar : e.target.files[0]}) ) */}
            </td>
          </tr>
          <tr>
            <td colSpan={2}>
