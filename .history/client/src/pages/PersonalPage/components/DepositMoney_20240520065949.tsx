      ...
      <div className="w-[100%] h-[90vh] overflow-auto flex pb-[1000px]">
        ...
        <div className="w-[20%] min-h-[100%] border-[1px]">
            <div className="w-[95%] h-[100px] border-[black]  border-[1px] m-[5px] p-[10px]">
              <h1 className="font-[500] text-[1.1rem]">Số dư tài khoản: </h1>
              <h1 className="font-[500] text-[1.1rem]">0đ</h1>
            </div>
            <button className="">Lịch sử nạp tiền</button> <br />
            <button className="">Lịch sử thanh toán</button> <br />
