    ...
    <div className=" h-[100vh] ">
      ...
      <div className="w-[100%] h-[90vh] overflow-auto flex pb-[1000px]">
        ...
        <div className="w-[20%] min-h-[100%] border-[1px]">
            ...
            <button className="w-[100%] flex items-center h-[30px] m-[5px] font-[600] text-[1.1rem] text-white bg-[#6c757d]">Lịch sử nạp tiền
            <FaChevronRight className='font-[600] text-[1.1rem] text-white'  />
            </button> <br />
            <button className="w-[100%] flex items-center h-[30px] m-[5px] font-[600] text-[1.1rem] text-white bg-[#6c757d]">Lịch sử thanh toán
            <FaChevronRight className='font-[600] text-[1.1rem] text-white' />
            </button> <br />
            <button className="w-[100%] flex items-center h-[30px] m-[5px] font-[600] text-[1.1rem] text-white bg-[#6c757d]">Bảng giá dịch vụ
            <FaChevronRight className='font-[600] text-[1.1rem] text-white' />
            </button>
        </div>
      </div>
