      ...
      <div className="w-[100%] h-[90vh] overflow-auto flex pb-[1000px]">
        ...
        <div className="w-[20%] min-h-[100%] border-[1px]">
            <div className="w-[95%] h-[100px] border-[black]  border-[1px] m-[5px] p-[10px]">
              ...
              <h1 className="font-[700] text-[1.4rem] text-[green]">0đ</h1>
            </div>
            <button className="w-[100%] flex items-center justify-center h-[30px] m-[5px] font-[600] text-[1.1rem] text-white bg-[#6c757d]">Lịch sử nạp tiền
            <FaChevronRight className='font-[600] text-[1.2rem] text-white m-[5px]'  />
            </button> <br />
            <button className="w-[100%] flex items-center justify-center h-[30px] m-[5px] font-[600] text-[1.1rem] text-white bg-[#6c757d]">Lịch sử thanh toán
            <FaChevronRight className='font-[600] text-[1.2rem] text-white m-[5px]' />
            </button> <br />
            <button className="w-[100%] flex items-center justify-center h-[30px] m-[5px] font-[600] text-[1.1rem] text-white bg-[#6c757d]">Bảng giá dịch vụ
            <FaChevronRight className='font-[600] text-[1.2rem] text-white m-[5px]' />
            </button>
        </div>
      </div>
