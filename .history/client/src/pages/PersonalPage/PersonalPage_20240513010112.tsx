                ...
                <div className="bg-[#055699] h-[40px]" >
                    ...
                    <div className="w-[100%] min-h-[100%] p-[10px]">
                        ...
                        <div className="">
                            <ul>
                            <Link to="/">
                                <li className={`flex items-left justify-center h-[40px] hover:bg-white ${activeItem === 1 ? "font-[700] bg-gray-200" : ""} `}
                                    onClick={() => handleHeaderActive(1)}>
                                    <span>  Quản lý đăng tin</span>
                                </li>
                            </Link>
                            <Link to="/">
                                <li className={`flex items-left justify-center h-[40px] hover:bg-white ${activeItem === 2 ? "font-[700] bg-gray-200" : ""} `}
                                    onClick={() => handleHeaderActive(2)}>
                                    <span>  Sửa thông tin cá nhân</span>
                                </li>
                            </Link>
                            <Link to="/">
                                <li className={`flex items-left justify-center h-[40px] hover:bg-white ${activeItem === 3 ? "font-[700] bg-gray-200" : ""} `}
                                    onClick={() => handleHeaderActive(3)}>
                                    <span>  Nạp tiền vào tài khoản</span>
                                </li>
                            </Link>
                            <Link to="/">
                                <li className={`flex items-left justify-center h-[40px] hover:bg-white ${activeItem === 4 ? "font-[700] bg-gray-200" : ""} `}
                                    onClick={() => handleHeaderActive(4)}>
                                    <span>  Lịch sử nạp tiền</span>
                                </li>
                            </Link>
                            <Link to="/">
                                <li className={`flex items-left justify-center h-[40px] hover:bg-white ${activeItem === 5 ? "font-[700] bg-gray-200" : ""} `}
                                    onClick={() => handleHeaderActive(5)}>
                                    <span>  Lịch sử thanh toán</span>
                                </li>
                            </Link>
                            <Link to="/">
                                <li className={`flex items-left justify-center h-[40px] hover:bg-white ${activeItem === 6 ? "font-[700] bg-gray-200" : ""} `}
                                    onClick={() => handleHeaderActive(6)}>
                                    <span>  Bảng giá dịch vụ</span>
                                </li>
                            </Link>
                            <Link to="/">
                                <li className={`flex items-left justify-center h-[40px] hover:bg-white ${activeItem === 7 ? "font-[700] bg-gray-200" : ""} `}
                                    onClick={() => handleHeaderActive(7)}>
                                    <span> Liên hệ </span>
                                </li>
                            </Link>
                            <Link to="/">
                                <li className={`flex items-left justify-center h-[40px] hover:bg-white ${activeItem === 8 ? "font-[700] bg-gray-200" : ""} `}
