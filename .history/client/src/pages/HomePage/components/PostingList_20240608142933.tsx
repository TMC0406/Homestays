...
import ItemDetail from '../../../components/Pagination/ItemDetail/ItemDetail.tsx'
...
const PostingList = () => {
  ...
  //   dispatch({type: actionTypes.GET_POSTS_LIMIT ,data:response.data, count:response.data.response?.count})
  // }
  // useEffect(  () => {
  //   getPostLimit(10)
  // },[]) 
