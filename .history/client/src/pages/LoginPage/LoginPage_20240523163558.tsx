...
const handleSubmit = async () => {
  dispatch(actionTypes.register(payload))
}
  ...
  return (
    <section className='mw-600 m-auto my-[10px]'>
      <div className='bg-[#ffffff] max-w-[600px] m-auto px-[30px] pt-[30px] pb-[100px] rounded-[10px]'>
        ...
        <React.Fragment>
          {isRegister && <Input label={'HỌ TÊN'} id={'text'} style={'text'} type={'name'} value={payload.name} setValue={setPayload}/>}
          <Input label={'SỐ ĐIỆN THOẠI'} id={'number'} style={'number'} type={'phone'} value={payload.phone} setValue={setPayload}/>
          <Input label={'MẬT KHẨU'} id={'password'} style={'password'} type={'password'} value={payload.password} setValue={setPayload}/>
        </React.Fragment>
