...
// }
const checkName = (payload:any)=>{
  switch (payload.name) {
          case "":
            let newArr = invalidFields.push({name : "name",message : "không được để trống"})
            break;
            case payload.name.length < 10:
...
const checkPhone = (payload:any)=>{
  switch (payload.phone) {
    case "":
      
      break;
      case payload.phone.length < 10:
...
const checkPassword = (payload:any)=>{
