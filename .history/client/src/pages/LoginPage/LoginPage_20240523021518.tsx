  ...
  return (
    <section className='mw-600 m-auto my-[10px]'>
      <div className='bg-[#ffffff] max-w-[600px] m-auto px-[30px] pt-[30px] pb-[100px] rounded-[10px]'>
        ...
        <React.Fragment>
          {isRegister && <Input label={'HỌ TÊN'} id={'text'} type={'text'} value={payload.name}/>}
          <Input label={'SỐ ĐIỆN THOẠI'} id={'number'} type={'number'} value={payload.phone}/>
          <Input label={'MẬT KHẨU'} id={'password'} type={'password'} value={payload.password}/>
        </React.Fragment>
