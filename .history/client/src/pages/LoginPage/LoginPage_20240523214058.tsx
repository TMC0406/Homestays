...
//     isRegister ? dispatch({ type: actionTypes.REGISTER_SUCCESS, data: response.data }) : dispatch({type: actionTypes.LOGIN, data: response.data});
//     ;
//   } catch (error) {
//     dispatch({ type: actionTypes.REGISTER_FAIL, data: error.message });
//   }
// };
      ...
      <div className='bg-[#ffffff] max-w-[600px] m-auto px-[30px] pt-[30px] pb-[100px] rounded-[10px]'>
        ...
        <div className='mb-[20px]'>
          <Button
            ...
            bgColor={'bg-[#3961fb]'}
            className={'w-full h-[45px] font-bold'} onClick={handleSubmitv2}          />
        </div>
