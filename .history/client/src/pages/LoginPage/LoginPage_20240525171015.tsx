...
import {register} from '../../redux/actions/actionChilds/actionRegister.js';
import {loginn} from '../../redux/actions/actionChilds/actionLogin.js'

const LoginPage = () => {
  const location = useLocation()
  const dispatch = useDispatch()
  const navigate = useNavigate()
  const isLoggedIn = useSelector((state:any)=> state.auth.isRegister)
...
const handleSubmit = async () => {
  ...
  //   }
  // }
  isRegister ? dispatch(register(payload)) : dispatch(loginn(payload))
