  ...
  return (
    <section className='mw-600 m-auto my-[10px]'>
      <div className='bg-[#ffffff] max-w-[600px] m-auto px-[30px] pt-[30px] pb-[100px] rounded-[10px]'>
        ...
        <React.Fragment>
            <Input label={'HỌ TÊN'} id={'text'} type={'text'}/>
            <Input label={'SỐ ĐIỆN THOẠI'} id={'number'} type={'number'}/>
            <Input label={'TẠO MẬT KHẨU'} id={'password'} type={'password'}/>
            <Input label={'LOẠI TÀI KHOẢN'} id={'radio'} type={'radio'}/>
        </React.Fragment>
