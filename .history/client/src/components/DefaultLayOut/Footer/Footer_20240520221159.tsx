    ...
    <div className='footer w-[100%] min-h-[50vh] bg-white pb-[50px]'>
      <div className="w-[ w-[1100px] mx-auto mt-[20px]]">
                ...
                return(
                  <div className="p-[10px]">
                    ...
                    <div className=" grid grid-cols-4">
                      {
                        item.listImg.map((item2)=>{
                          return(
                            <img src={item2.imgSrc} alt="" className='w-[70%] h-[70%]  p=[10px] m-[10px]' />
                          )
                        })
                      }
                    </div>
        ...
        <div className="text-center p-[20px]">
            <p className="text-[] font-[600]">CÔNG TY TNHH HOSMTAY HEALING</p>
            <p className="text-[] font-[600]">Tổng đài CSKH: 099999999</p>
            <p className="">Copyright © 2015 - 2024 homstayhealing.com</p>
            <p className="">Email: cskh.homstayhealing@gmail.com</p>
            <p className="">Địa chỉ: LD -37 tòa bigcenter 75 giải phóng </p>
            <p className="">Giấy phép đăng ký kinh doanh số 999999 do Sở kế hoạch và Đầu tư thành phố Hà Nội cấp ngày 20 tháng 5 năm 2024.</p>
        </div>
        <br /><br /><br />
      </div>
        <div className="w-[100%] h-[30px] bg-[#febb02] rounded-[10px]"></div>
    </div>
  )
}
