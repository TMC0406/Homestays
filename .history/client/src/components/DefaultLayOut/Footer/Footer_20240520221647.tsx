    ...
    <div className='footer w-[100%] min-h-[50vh] bg-white pb-[50px]'>
      <div className="w-[ w-[1100px] mx-auto mt-[20px]]">
        ...
        <div className="text-center p-[20px]">
            <p className="pb-[5px]  text-[] font-[600]">CÔNG TY TNHH HOSMTAY HEALING</p>
            <p className="pb-[5px]  text-[] font-[600]">Tổng đài CSKH: 099999999</p>
            <p className="pb-[5px]  ">Copyright © 2015 - 2024 homstayhealing.com</p>
            <p className="pb-[5px]  ">Email: cskh.homstayhealing@gmail.com</p>
            <p className="pb-[5px]  ">Địa chỉ: LD -37 tòa bigcenter 75 giải phóng </p>
            <p className="pb-[5px]  ">Giấy phép đăng ký kinh doanh số 999999 do Sở kế hoạch và Đầu tư thành phố Hà Nội cấp ngày 20 tháng 5 năm 2024.</p>
        </div>
        <br /><br /><br />
      </div>
