    ...
    <div className="">
      ...
      {/* <ItemDetail/> */}
        ...
        <div className="box-btn">
          <button  className="m-[5px] p-[5px] border-[px]"  onClick={handlePrev}>Previous</button>
          {number.map((it) => (
            <button className="m-[5px] p-[5px] border-[px]" key={it} onClick={() => handleChange(it)}>
              {it}
            </button>
          ))}
          <button  className="m-[5px] p-[5px] border-[px]"  onClick={handleNext}>Next</button>
        </div>
      </div>
    </div>
  );
