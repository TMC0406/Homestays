    ...
    <div className="">
      ...
      {/* <ItemDetail/> */}
        ...
        <div className="box-btn">
          <button  className="m-[5px] p-[5px] border-[1px]"  onClick={handlePrev}>Previous</button>
          {number.map((it) => (
            <button className="m-[5px] p-[5px] border-[1px]" key={it} onClick={() => handleChange(it)}>
              {it}
            </button>
          ))}
          <button  className="m-[5px] p-[5px] border-[1px]"  onClick={handleNext}>Next</button>
        </div>
      </div>
    </div>
  );
