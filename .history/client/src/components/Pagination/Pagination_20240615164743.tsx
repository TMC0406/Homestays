...
const {FaLongArrowAltLeft, FaLongArrowAltRight, FaRegArrowAltCircleLeft} = icons
    ...
    <div className="">
      ...
      {/* <ItemDetail/> */}
        ...
        <div className="box-btn flex">
          <Button text={''} onClick={handlePrev} className={"m-[5px] p-[5px] border-[2px]"} icon={<FaRegArrowAltCircleLeft/>}/>
          {number.map((it) => (
          ...
          <Button text={''} onClick={handleNext} className={'m-[5px] p-[5px] border-[2px] text-center'} icon={<FaLongArrowAltRight/>}/>
        </div>
      </div>
    </div>
  );
