  ...
  return (
    <div className='w-full flex mb-[10px]'>
        <div className='w-[40%] flex flex-wrap gap-[2px] items-center relative'>
            ...
            <span className='bg-[#00000080] absolute bottom-[8px] left-[5px] text-[#fff] text-center w-[40px] h-[20px] rounded-[3px] text-[12px] px-[5px]'>4 ảnh</span>
            <span className='bg-[#00000080] absolute bottom-[8px] right-[5px] text-[#fff] text-center w-[40px] h-[20px] rounded-[3px] text-[12px] px-[5px]'><GoHeart/></span>
        </div>
