        ...
        <div className='w-[60%] ml-[15px]'>
            ...
            <div className='flex justify-between'>
                <div className='flex items-center '>
                    <img src="" alt="Avt" className='w-[30px] h-[30px] object-cover rounded-full' />
                    <p>Trọng</p>
                </div>
                <div className='flex'>
                    <Button text={'Gọi 0354159445'} textColor={undefined}  onClick={undefined} className={'bg-[#1266dd] text-[#fff] text-[13px] py-[3px] px-[7px] mr-[5px]'} icon={undefined}/>
                    <Button text={'Nhắn Zalo'} textColor={undefined} onClick={undefined} className={'bg-[#fff] text-[#1266dd] text-[13px] py-[3px] px-[7px] border-[1px] border-solid border-[#1266dd]'} icon={undefined}/>
                </div>
            </div>
        </div>  
    </div>
