        ...
        <div className='w-[60%] ml-[15px]'>
            ...
            <div className='flex justify-between'>
                ...
                <div className='flex'>
                    ...
                    <Button text={'Nhắn Zalo'} textColor={undefined} onClick={undefined} className={'bg-[#fff] text-[#1266dd] text-[13px] py-[3px] px-[7px] border-[1px] border-[#1266dd]'} icon={undefined}/>
                </div>
            </div>
        </div>  
    </div>
