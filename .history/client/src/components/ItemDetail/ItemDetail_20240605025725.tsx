    ...
    <div className='w-full flex mb-[10px]'>
        ...
        <div className='w-[60%] ml-[15px]'>
            ...
            <div className='flex justify-between'>
                ...
                <div className='flex'>
                    <Button text={'Gọi 0354159445'} textColor={undefined}  onClick={undefined} className={'bg-[#1266dd] text-[#fff] text-[11px] py-[3px] px-[7px]'} icon={undefined}/>
                    <Button text={'Nhắn Zalo'} textColor={undefined} onClick={undefined} className={undefined} icon={undefined}/>
                </div>
            </div>
        </div>  
    </div>
