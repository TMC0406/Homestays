        ...
        <div className='w-full flex mb-[10px] py-[15px]  border-t-[1px] border-solid border-[#E13427]'>
            ...
            <div className='w-[60%] ml-[15px]'>
                ...
                <div className='flex justify-between'>
                    ...
                    <div className='flex'>
                        <Button text={`Gọi ${user?.phone}`} onClick={undefined} className={'bg-[#1266dd] text-[#fff] text-[13px] py-[3px] px-[7px] mr-[5px] hover:border-[#1266dd]  hover:border-[1px] hover:border-solid hover:bg-[#fff] hover:text-[#1266dd] hover:no-underline'} icon={undefined} />
