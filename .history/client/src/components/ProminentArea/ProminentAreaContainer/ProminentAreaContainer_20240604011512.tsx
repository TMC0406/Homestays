...
const ProminentAreaContainer = ({name, img}) => {
  return (
    <div className='w-[220px] cursor-pointer shadow-[0_0_10px_1px_rgb(0,0,0,0.1)] rounded-[10px] text-[#1266DD] hover:text-[#FF6600] hover:shadow-[0_0_10px_10px_rgb(0,0,0,0.05)]'>
        <img 
        src={img}
        alt={name} 
